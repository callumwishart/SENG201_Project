...
public class Round {
     ...
     * @param inventoryService the inventoryService instance to be used
     * @param difficulty the instance of difficulty used to adjust round parameters to make easier/harder
     * @param roundNum the current round number - used to calculate various aspects of the round such as cart numbers
     * @throws CloneNotSupportedException where the resource cannot be cloned  while adding it to carts being created
     */
     ...
     * @return number of carts to be generated by the round class
     */
     ...
     * </p>
     * @param universal boolean indicating whether the cart is universal or not, this will generate a larger size as the cart will be easily filled by multiple towers

...
/**
 * Resource type metal which is generated by the mine
 */
public class Metal extends Resource{
    /**
     * Constructor of the metal class which initialises the name and cost
     */
    public Metal() {
        super("Metal", 35);
    }
    ...
    /**
     * Checks if the resource passed is equal to Metal and also checks if the object is null
